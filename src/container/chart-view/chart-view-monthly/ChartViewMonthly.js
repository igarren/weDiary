            ...
            <div className='Container'>
                <Grid style={{ marginBottom: '10px' }} centered columns={3}>
                    <Grid.Row className='HomeButtonGroup'>
                        <Grid.Column className='ButtonNotPadded' width={4}> <Button btnType='action' btnStyle='Main'> ≪ </Button> </Grid.Column>
                        <Grid.Column className='ButtonNotPadded' width={8}> <Button btnType='action' btnStyle='Main'> 今月 </Button>  </Grid.Column>
                        <Grid.Column className='ButtonNotPadded' width={4}> <Button btnType='action' btnStyle='Main'> ≫ </Button>  </Grid.Column>
                    </Grid.Row>
                </Grid>
